#!c:\users\nicog\appdata\local\programs\python\python36-32\python.exe
...
import r_pdfminer
from r_pdfminer.pdfdocument import PDFDocument, PDFNoOutlines, PDFXRefFallback, \
    PDFNoValidXRefWarning
from r_pdfminer.pdfpage import PDFPage
from r_pdfminer.pdfparser import PDFParser
from r_pdfminer.pdftypes import PDFObjectNotFound, PDFValueError
from r_pdfminer.pdftypes import PDFStream, PDFObjRef, resolve1, stream_value
from r_pdfminer.psparser import PSKeyword, PSLiteral, LIT
from r_pdfminer.utils import isnumber
