...
if module == "readTextBoxes":
    ...
    with open(path, "rb") as pdf:
        ...
        for box in pdf_fields:
            resultado[pdf_fields[box].get("/T")] = pdf_fields[box].get("/V")
            
        # resultado = {pdf_fields[box].get("/T"): pdf_fields[box].get("/V") for box in pdf_fields}
        print(resultado)

        SetVar(result, resultado)
